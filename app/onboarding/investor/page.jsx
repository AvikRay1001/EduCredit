...
export default function InvestorOnboardingPage() {
    ...
    const handleNextStep = () => {
        ...
        if (currentStep === 0) {
            if (!formData.personalDetails.name?.trim()) {
                ...
                currentErrors["personalDetails.name"] = "Name must be at least 3 characters";
            }
            ...
            if (formData.personalDetails.bio?.length > 500) {
                currentErrors["personalDetails.bio"] = "Bio must be less than 500 characters";
            }
            ...
            if (!formData.professional.experience) {
                currentErrors["professional.experience"] = "Years of experience is required";
            } else if (isNaN(formData.professional.experience) || formData.professional.experience < 0) {
            ...
            if (formData.investment.focusAreas.length === 0) {
                currentErrors["investment.focusAreas"] = "Select at least one focus area";
            }

            if (!formData.investment.checkSize) {
                currentErrors["investment.checkSize"] = "Check size is required";
            } else if (isNaN(formData.investment.checkSize) || formData.investment.checkSize <= 0) {
                currentErrors["investment.checkSize"] = "Enter a valid amount";
            }

            if (!formData.investment.investmentStage) {
                currentErrors["investment.investmentStage"] = "Investment stage is required";
            }
        }
    ...
    const focusAreaOptions = [
        "EdTech", "FinTech", "HealthTech", "AI/ML",
        "Blockchain", "SaaS", "Marketplaces", "Consumer"
    ];

    // Industry options
    const industryOptions = [
        "Technology", "Finance", "Healthcare", "Education",
        "Media", "Retail", "Manufacturing", "Consulting"
    ];
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="mb-10">
                            ...
                            <p className="text-slate-400 mt-3">
                                Complete your investor profile to start funding education opportunities
                            </p>
                        </div>
                            ...
                            <div className="flex justify-between mb-2">
                                {steps.map((step, index) => (
                                    <div key={step} className="flex flex-col items-center">
                                        <div
                                            className={`h-8 w-8 rounded-full flex items-center justify-center ${currentStep >= index ? 'bg-blue-500 text-white' : 'bg-slate-800 text-slate-400 border border-slate-700'}`}
                                        >
                                            {currentStep > index ? (
                                        ...
                                        <span className={`text-xs mt-1 ${currentStep >= index ? 'text-blue-400' : 'text-slate-500'}`}>
                                            {step}
                                        </span>
                                    </div>
                                ))}
                                            ...
                                            <div className="space-y-6">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full rounded-md bg-slate-800/50 border border-slate-700 text-white placeholder:text-slate-500 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition-colors ${errors["personalDetails.name"] ? "border-red-500" : ""
                                                            }`}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full rounded-md bg-slate-800/50 border border-slate-700 text-white placeholder:text-slate-500 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition-colors ${errors["personalDetails.location"] ? "border-red-500" : ""
                                                            }`}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        className={`w-full rounded-md bg-slate-800/50 border border-slate-700 text-white placeholder:text-slate-500 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition-colors ${errors["personalDetails.bio"] ? "border-red-500" : ""
                                                            }`}
                                                        rows={3}
                                                    />
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-6">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex flex-wrap gap-2 mb-3">
                                                        {formData.portfolio.preferredVerticals.map((vertical) => (
                                                            <span
                                                                key={vertical}
                                                    ...
                                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                                        {focusAreaOptions
                                                            .filter(
                                                                (area) =>
                                                                    !formData.portfolio.preferredVerticals.includes(area)
                                                            )
                                                            .map((area) => (
                                                                <motion.div
                                                                    key={area}
